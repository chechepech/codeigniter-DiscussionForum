...
class Comments extends MY_Controller {
    ...
    public function index() {
        ...
        //validate if a discussion exists.
        if ($this->Discussions_model->fetch_discussion($ds_id) == FALSE){redirect('/');}
        ...
        if ($this->form_validation->run() == FALSE) { 
            ...
            $data = array('cm_body' => $this->input->post('comment_body',TRUE),
                          'usr_email' => $this->input->post('comment_email',TRUE),
                          'usr_name' => $this->input->post('comment_name',TRUE),
                          'ds_id' =>  $this->input->post('ds_id', TRUE)
                          );
