...
class Comments_model extends CI_Model
{
	...
	/*This fetches all active comments that are associated
	with the current discussion from the  comments table .*/
	public function fetch_comments($ds_id = null) {
	...
	/*This creates a new record in the  comments table.
	The comment is associated with  users.usr_id and  discussions.ds_id.*/
	public function new_comment($data = NULL) {
	...
	/*This sets a comment as being lagged for moderation by setting
	comments.cm_is_active to 0.*/
	public function flag($cm_id = NULL) {
        $query = "UPDATE comments SET cm_is_active = 0 WHERE cm_id = ?";
